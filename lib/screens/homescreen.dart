                ...
                child: Column(
                  ...
                  children: [
                    TextFormField(
                      ...
                      decoration:
                      const InputDecoration(labelText: 'Subject/Topic Name'),
                      validator: (value) {
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: 'Study Material'),
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        TextFormField(
                          controller: _nameController,
                          decoration: const InputDecoration(labelText: 'Subject/Topic Name'),
                        ),
                        TextFormField(
                          controller: _studymatController,
                          decoration: const InputDecoration(labelText: 'Study Material'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Firebase Lab' ,style: TextStyle(fontSize: 26 , color: Colors.white),),
        centerTitle: true,
      ),
      body: Column(
        children: [
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final task = Task.fromMap(sortedTasks[index].data() as Map<String, dynamic> );
